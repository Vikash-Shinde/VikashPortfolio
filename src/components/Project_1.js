    ...
    {/* please check spellings  */}
      <section className='home_hero' id='Project_1'>
        <div className="position-relative overflow-hidden text-center p-3 p-md-5 my-0 bg-light about_hero_content" >
          <div className="col-md-8 p-lg-5 mx-auto my-5 " >
            ...
            <a className="btn btn-warning fw-bolder fs-3 py-3 mt-5 text-dark live_btn shadow-lg" href="https://vikash-shinde.github.io/NEWs2U/" target={'_blank'}>LIVE LINK</a>
          </div>
      ...
      <div className="px-4 pt-5 my-5 text-center border-bottom home_hero_content ">
        ...
        <div className="col-lg-6 mx-auto mt-5 text-start">
          ...
          <a className="btn btn-warning fw-bolder  p-3   m-3 text-dark live_btn shadow" href="https://vikash-shinde.github.io/NEWs2U/" target={'_blank'}>LIVE LINK</a>
